# Communication Forensic Dashboard

A React-based visualization interface for the Communication Analysis Toolkit.

## Overview
This dashboard provides a visual layer over the analysis engine's output (`DATA.json` / `cases.db`). It allows forensic analysts and researchers to:
